...
const Post = ({post}) => {
  ...
  export async function getStaticProps({ params }) {
	...
	const res = await fetch(`https://native.tportal.hr/planet-b/wp-json/wp/v2/posts/${params.id}?_fields=id,title,content,acf,featured_media,better_featured_image,date`)
